...
constexpr std::string_view _free_email_domains[] = { "gmail.com:yahoo.com:hotmail.com" };
...
constexpr std::string_view _street_suffixes[] { 
...
constexpr std::string_view _first_name_male[] { 
...
constexpr std::string_view _first_name_female[] { 
...
constexpr std::string_view _last_names[] { 
